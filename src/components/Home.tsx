...
const KalaKrutLogo = ({ className = 'w-32 h-32' }: { className?: string }) => (
  ...
  >
    ...
    <path
      d="M60 100 Q 100 20, 140 100 T 60 100"
      stroke="white"
      strokeWidth="4"
      strokeLinecap="round"
      fill="none"
    ...
    <div className="min-h-screen bg-kala-900 text-slate-200">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-kala-300 leading-relaxed">
              <p>
                KalaKrut Creative is built for the worldwide community of
                artists, organizers, grantmakers, and revellers. We facilitate
                ease of business by bringing fragmented workflows—booking,
                ticketing, IP management, and auctions—into a single, secure
                portal.
              </p>
              <p>
                Whether you are selling physical art, renting instruments, or
                booking a world tour, our platform handles the complexity so you
                can focus on the art. With separate, tailored dashboards for
                every role, we ensure that Admins can monitor health while DAO
                members govern the future.
              </p>
            </div>
            <button
              onClick={() => startTransition(() => onViewNews())}
              className="mt-8 flex items-center gap-2 text-kala-secondary font-bold hover:gap-3 transition-all"
            >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-2 flex items-center justify-center gap-3">
              <Activity className="text-kala-secondary w-8 h-8" /> Community
              Barometer
            </h2>
            <p className="text-kala-400">
              Live ecosystem metrics indicating the health and growth of the
              collective.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <div className="text-sm text-kala-400 uppercase font-bold tracking-wider mb-4 relative z-10">
                Active Members
              </div>
            ...
            <div className="bg-kala-800/50 rounded-2xl p-6 border border-kala-700 hover:border-purple-500/50 transition-all group">
              ...
              <div className="text-4xl font-bold text-white mb-1 tracking-tight">
                {stats.activeGigs.toLocaleString()}
              </div>
              <div className="text-sm text-kala-400 uppercase font-bold tracking-wider mb-4">
                Gigs Completed
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-kala-400 mt-2">
            Log in to access your specialized dashboard.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <LoginCard
            ...
            icon={Music}
            desc="Manage your EPK, accept bookings, and sell merch."
          />
          <LoginCard
            role={UserRole.VENUE}
            icon={Building2}
            desc="Scout talent and manage event calendars."
          />
          <LoginCard
            role={UserRole.SERVICE_PROVIDER}
            icon={Users}
            desc="Offer consultancy or production services."
          />
          <LoginCard
            role={UserRole.ORGANIZER}
            icon={Building2}
            desc="Plan festivals and manage lineups."
          />
          <LoginCard
            role={UserRole.SPONSOR}
            icon={Coins}
            desc="Fund events and support artists."
          />
          <LoginCard
            role={UserRole.REVELLER}
            icon={Users}
            desc="Buy tickets and follow your favorite artists."
          />
          <LoginCard
            role={UserRole.ADMIN}
            icon={ShieldCheck}
          ...
          <LoginCard
            ...
            icon={ShieldCheck}
            desc="Govern the DAO and its Business."
          />
          <LoginCard
            role={UserRole.DAO_MEMBER}
            icon={Globe2}
            desc="Create proposals and Vote on proposals"
          />
        </div>
      </div>
      {/* Footer */}
      <footer className="bg-kala-900 border-t border-kala-800 py-12">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-4">
            <a
              href="https://x.com/KalaKrut"
              target="_blank"
              rel="noreferrer"
              className="p-2 bg-kala-800 rounded-full text-kala-400 hover:text-white hover:bg-kala-700 transition-colors"
            >
              <XIcon className="w-4 h-4" />
            </a>
            <a
              href="https://www.instagram.com/kalakrut?igsh=MWcyc2htOGpwN3owYw=="
              target="_blank"
              rel="noreferrer"
              className="p-2 bg-kala-800 rounded-full text-kala-400 hover:text-white hover:bg-kala-700 transition-colors"
            >
            ...
            <a
              href="https://www.facebook.com/kalakrutagn?mibextid=ZbWKwL"
              target="_blank"
              rel="noreferrer"
              className="p-2 bg-kala-800 rounded-full text-kala-400 hover:text-white hover:bg-kala-700 transition-colors"
            >
            ...
            <a
              href="https://kalakrut.substack.com/"
              target="_blank"
              rel="noreferrer"
              className="p-2 bg-kala-800 rounded-full text-kala-400 hover:text-white hover:bg-kala-700 transition-colors"
            >
            ...
            <a
              href="https://discord.com/invite/Nk5e4HCX"
              target="_blank"
              rel="noreferrer"
              className="p-2 bg-kala-800 rounded-full text-kala-400 hover:text-white hover:bg-kala-700 transition-colors"
            >
            ...
            <a
              href="https://linktr.ee/KalaKrutPlatform"
              target="_blank"
              rel="noreferrer"
              className="p-2 bg-kala-800 rounded-full text-kala-400 hover:text-white hover:bg-kala-700 transition-colors"
            >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in">
          <div className="bg-kala-900 border border-kala-700 rounded-2xl w-full max-w-2xl overflow-hidden shadow-2xl relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8 border-t border-kala-800 bg-kala-800/20">
              ...
              <div className="flex flex-col items-center p-6 bg-kala-800/50 rounded-xl border border-kala-700 hover:border-purple-500 transition-colors group">
                ...
                <p className="text-xs text-kala-400 text-center mb-6 h-10">
                  Connect MetaMask, Phantom, or WalletConnect. Best for DAO
                  Members and NFT Trading.
                </p>
                <button
            ...
            <div className="p-4 bg-kala-900 border-t border-kala-800 text-center text-xs text-kala-500">
              By continuing, you agree to our Terms of Service. Both login
              methods provide secure access to your portal.
            </div>
          </div>
        </div>
      )}
